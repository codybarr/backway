...
export function getConfig(env: Env) {
  return {
    ...
    maxAssetCount: Number(env.MAX_ASSET_COUNT ?? 40),
    assetFetchTimeoutMs: Number(env.ASSET_FETCH_TIMEOUT_MS ?? 5000),
    processingDeadlineMs: Number(env.PROCESSING_DEADLINE_MS ?? 25000),
